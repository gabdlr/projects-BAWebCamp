...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Editar registro
        <small>completa el formulario para editar un registro de usuario</small>
      </h1>
                ...
                <form role="form" name="guardar-registro" id="guardar-registro" method="POST" action="modelo-registrado.php">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input name="nombre" type="text" class="form-control" id="nombre" value="<?php echo $registrado['nombre_registrado']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="apellido">Apellido:</label>
                            <input name="apellido" type="text" class="form-control" id="apellido" value="<?php echo $registrado['apellido_registrado']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="email">Email:</label>
                            <input name="email" type="email" class="form-control" id="email" value="<?php echo $registrado['email_registrado']; ?>">
                        </div>
                        <?php 
                        
                        $pedido = $registrado['pases_articulos'];
                        //En el json_decode el segundo param como true para que me regrese un array en lugar de un object
                                    ...
                                    <li class="col-md-4">
                                        <div class="tabla-precio text-center">
                                            ...
                                            <div class="orden"><label for="pase_dia">Boletos deseados:</label>
                                                <input value="<?php echo $boletos['un_dia']['cantidad']; ?>" type="number" class="form-control" name="boletos[un_dia][cantidad]" min="0" id="pase_dia" size="3" placeholder="0">
                                    ...
                                    <li class="col-md-4">
                                        <div class="tabla-precio text-center">
                                            ...
                                            <div class="orden"><label for="pase_completo">Boletos deseados:</label>
                                                <input value="<?php echo $boletos['pase_completo']['cantidad']; ?>" type="number" class="form-control" name="boletos[completo][cantidad]" min="0" id="pase_completo" size="3" placeholder="0">
                                    ...
                                    <li class="col-md-4">
                                        <div class="tabla-precio text-center">
                                            ...
                                            <div class="orden"><label for="pase_dos_dias">Boletos deseados:</label>
                                                <input value="<?php echo $boletos['pase_2dias']['cantidad']; ?>" type="number" class="form-control" name="boletos[2dias][cantidad]" min="0" id="pase_dos_dias" size="3" placeholder="0">
                                    ...
                                    <?php foreach ($eventos_dias as $dia => $eventos) { ?>
                                            <div id="<?php echo $dia; ?>" class="contenido-dia clearfix row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <label><input <?php echo (in_array($evento['id'], $id_eventos_registrados['eventos']) ? 'checked' : '') ; ?> type="checkbox" class="minimal" name="registro_evento[]" id="<?php echo $evento['id']?>" value="<?php echo $evento['id']?>">
                                ...
                                <div class="caja clearfix row" >
                                    <div class="extras col-md-6">
                                        <div class="orden">
                                            ...
                                            <input value="<?php echo $boletos['camisas']; ?>" type="number" class="form-control" name="pedido_extra[camisas][cantidad]" min="0" id="camisa_evento" size="3" placeholder="0">
                                            <input type="hidden" value="10" name="pedido_extra[camisas][precio]">
                                        </div>
                                        <!--.orden-->
                                        <div class="orden">
                                            <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(HTML, CSS3, JavaScript)</small></label>
                                            <input value="<?php echo $boletos['etiquetas']; ?>" type="number" class="form-control" name="pedido_extra[etiquetas][cantidad]" min="0" id="etiquetas" size="3" placeholder="0">
                                    ...
                                    <div class="total col-md-6">
                                        ...
                                        <p>Total ya pagado: <br>$<?php echo (float) $registrado['total_pagado']; ?></p>
                                        <p>Total: </p>
