...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Editar evento
        <small>edita los eventos ya creados</small>
      </h1>
          ...
          <form role="form" name="guardar-registro" id="guardar-registro" method="POST" action="modelo-evento.php">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input name="titulo_evento" type="text" class="form-control" id="titulo_evento" value="<?php echo $evento['nombre_evento']?>">
                  </div>
                  <div class="form-group">
                      ...
                      <select name="categoria_evento" class="form-control seleccionar">
                        ...
                        <?php } else {?> <option value="<?php echo $cat_evento['id_categoria']; ?>">
                                                <?php echo $cat_evento['cat_evento']; ?>
                                        </option>
                          <?php } }
